...
function sentiment(text) {
  let positive = text.match(positiveRegex);
  let negative = text.match(negativeRegex);

  return `There are ${positive.length} positive words in the text.
  Positive sentiments: ${positive.join(', ').toLowerCase()}
  
  There are ${negative.length} negative words in the text.
  Negative sentiments: ${negative.join(', ').toLowerCase()}
